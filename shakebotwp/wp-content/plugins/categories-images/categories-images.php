...
define('Z_IMAGE_PLACEHOLDER', Z_PLUGIN_URL."/images/acts.png");
...
function z_add_style() {
	echo '<style type="text/css" media="screen">
		...
		.inline-edit-row fieldset .thumb img,.column-thumb img {width:48px;height:48px;}
                 #taxonomy_image {margin-bottom: 10px !important ;}
	</style>';
}
...
function z_add_texonomy_field() {
	...
	echo '<div class="form-field">
		...
		<input type="text" name="taxonomy_image" id="taxonomy_image" class="iconforactivity" value="" />
		<br/>
