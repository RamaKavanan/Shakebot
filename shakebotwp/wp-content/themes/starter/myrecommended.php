...
<script src="<?php echo site_url(); ?>/wp-content/themes/starter/js/filter.js"></script> <!--filter.js?rand=10"-->
...
.rangeTxt{
	border:1; width: 40px; line-height: normal; /*background-color:#fff;*/ 
}
			...
			<div class="col-md-12"  style="border:0px solid red; padding:0px;">	
				...
				<div class="col-md-9" style="border:0px solid black; overflow:hidden;" >
					<div class="row" style="margin-bottom:5px; ">
						...
						<div style="background-color:#eee; padding:7px 10px; border-bottom:1px solid #eee" class="col-md-8">
							<h4>Products</h4>
                                                        <!--<a href="#" class="simple-ajax-popup ">click</a>-->
                                                        

						</div>
						
						<!--<div style="background-color:#eee; padding:18px 5px 18px 0px; border:0px solid red; min-height:40px" class="col-md-4">-->							
						<div style="background-color:#eee; padding:7px; border:0px solid red; min-height:40px; overflow: auto;" class="col-md-4">
				...
				<input type="hidden" name="sortTyhd" id="sortTyhd" value="lth">
					...
					<div style="cursor: pointer;border:1px solid #E0E0E0; background-color:#3F3F3F; color:#fff; font-size: 13px; font-weight:bold; padding:5px;  max-width: 300px; margin-top:4px" id="filterPanelShow">&nbsp;&nbsp;FILTER BY
						<i id="cornerIcon" class="fa fa-caret-up" style="float:right; padding: 3px 8px;color: #888;font-size: 20px; cursor: pointer;"></i>						
					</div>
						...
						<div class="accordion">
							...
							<div >
								...
								<p style="padding-top:13px;">&nbsp;
									<span style="float:left;"><input class="rangeTxt" type="text" id="slider-rangerg1" readonly ></span>
									<span style="float:right;"><input class="rangeTxt" type="text" id="slider-rangerg2" readonly ></span>
								</p>
							</div>-->

							<h1>Refine by <b>SHAKEBOT RATING</b></h1>
							<div>   
                                                                <div>Drag sliders to filter results</div>
								<div id="slider-range1"></div>
								<p style="padding-top:13px;">&nbsp;
									<span style="float:left;"><input class="rangeTxt" type="text" id="slider-range1rg1"  ></span>
									<span style="float:right;"><input class="rangeTxt" type="text" id="slider-range1rg2"  ></span>
								</p>
                                                                <div><input type="button" id="range1" class="reset" value="Reset"></div>
							</div>
							...
							<div>   
								...
								<p style="padding-top:13px;">&nbsp;
									<span style="float:left;"><input class="rangeTxt" type="text" id="slider-range3rg1"  ></span>
									<span style="float:right;"><input class="rangeTxt" type="text" id="slider-range3rg2"  ></span>
								</p>
                                                                <div><input type="button" id="range3" class="reset" value="Reset"></div>
							</div>
							...
							<div>
								...
								<p style="padding-top:13px;">&nbsp;
									<span style="float:left;"><input class="rangeTxt" type="text" id="slider-range4rg1"  ></span>
									<span style="float:right;"><input class="rangeTxt" type="text" id="slider-range4rg2"  ></span>
								</p>
                                                                <div><input type="button" id="range4" class="reset" value="Reset"></div>
							</div>
							...
							<div>
								...
								<p style="padding-top:13px;">&nbsp;
									<span style="float:left;"><input class="rangeTxt" type="text" id="slider-range5rg1"  ></span>
									<span style="float:right;"><input class="rangeTxt" type="text" id="slider-range5rg2"  ></span>
								</p>
                                                                <div><input type="button" id="range5" class="reset" value="Reset"></div>
							</div>
							...
							<div>
								...
								<p style="padding-top:13px;">&nbsp;
									<span style="float:left;"><input class="rangeTxt" type="text" id="slider-range6rg1"  ></span>
									<span style="float:right;"><input class="rangeTxt" type="text" id="slider-range6rg2"  ></span>
								</p>
                                                                <div><input type="button" id="range6" class="reset" value="Reset"></div>
							</div>
							...
							<div>
								...
								<p style="padding-top:13px;">&nbsp;
									<span style="float:left;"><input class="rangeTxt" type="text" id="slider-range7rg1"></span>
									<span style="float:right;"><input class="rangeTxt" type="text" id="slider-range7rg2"></span>
								</p>
                                                                <div><input type="button" id="range7" class="reset" value="Reset"></div>
							</div>
