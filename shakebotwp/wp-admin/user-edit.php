...
<div id="message" class="updated notice is-dismissible">
	<?php if ( IS_PROFILE_PAGE ) { ?>
            <?php  if($_COOKIE['bannerMsg'] != ''){
            echo "<br />".$_COOKIE['bannerMsg']; }?>
                               <p><strong><?php _e('Profile updated.') ?> </strong></p>
	<?php }else{ ?>
            <?php  if($_COOKIE['bannerMsg'] != ''){
            echo "<br />".$_COOKIE['bannerMsg']; }?>
	<p><strong><?php _e('User updated.') ?> </strong>
	</p>
	<?php } ?>
...
<?php if($usrAd->roles[0] == "administrator"){ //Customized?>	<h3><?php _e('Personal Options'); ?></h3><?php } //Customized?>

<?php 
	$usrAd = wp_get_current_user(); 
	//print_r($usrAd);
?>

<table class="form-table">

<?php if($usrAd->roles[0] == "administrator"){ //Customized?>	
...
<tr class="user-nickname-wrap"><!-- Nick Name Customized-->
	<th><label for="nickname"><?php _e('Name'); ?> <span class="description"><?php _e('(required)'); ?></span></label></th>
...
<?php if($usrAd->roles[0] == "administrator"){ //Customized?><h3><?php _e('Account Management'); ?></h3><?php } //Customized?>
<table class="form-table">
