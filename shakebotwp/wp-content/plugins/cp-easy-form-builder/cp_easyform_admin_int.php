...
<input name="cp_easyform_post_options" type="hidden" id="1" />
<input name="cp_easyform_id" type="hidden" value="<?php echo CP_EASYFORM_ID; ?>" />
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
     <table class="form-table">    
        ...
        <td><input type="text" name="fp_from_email" size="40" value="<?php echo esc_attr(cp_easyform_get_option('fp_from_email', CP_EASYFORM_DEFAULT_fp_from_email)); ?>" /></td>
        </tr>             
        <tr valign="top">
        ...
        <td><textarea type="text" name="fp_message" rows="6" cols="80"><?php echo cp_easyform_get_option('fp_message', CP_EASYFORM_DEFAULT_fp_message); ?></textarea></td>
        </tr>                                                               
     </table>  
  </div>    
 </div>  
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
     <table class="form-table">    
        ...
        <tr valign="top">
        <th scope="row">Message</th>
        <td><textarea type="text" name="cu_message" rows="6" cols="80"><?php echo cp_easyform_get_option('cu_message', CP_EASYFORM_DEFAULT_cu_message); ?></textarea></td>
        </tr>        
     </table>  
  </div>    
 </div>   
  ...
  <div class="inside">
     <table class="form-table">    
        ...
        <tr valign="top">
         ...
         <td><input type="text" name="cv_background" size="10" value="<?php echo esc_attr(cp_easyform_get_option('cv_background', CP_EASYFORM_DEFAULT_cv_background)); ?>" onblur="generateCaptcha();" /></td>
         <th scope="row">Border:</th>
         <td><input type="text" name="cv_border" size="10" value="<?php echo esc_attr(cp_easyform_get_option('cv_border', CP_EASYFORM_DEFAULT_cv_border)); ?>" onblur="generateCaptcha();" /></td>        
        </tr>    
...
[<a href="http://wordpress.dwbooster.com/support?product=cp-easy-form-builder&version=1.1.3" target="_blank">Request Custom Modifications</a>] | [<a href="http://wordpress.dwbooster.com/calendars/cp-easy-form-builder" target="_blank">Help</a>]
</form>
</div>
