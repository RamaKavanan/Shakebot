...
function zerif_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'zerif_ourfocus_section' , array(
			...
			//'title'       => __( 'Our focus section', 'zerif-lite' ),Our focus section
			'title'       => __( 'About Shakebot section', 'zerif-lite' ),
    ...
    $wp_customize->add_control(
		...
		array(
			...
			//'label' => __('Hide our focus section?','zerif-lite'), About Shakebot
			'label' => __('Hide About Shakebot section?','zerif-lite'), 
	...
	$wp_customize->add_setting( 'zerif_ourfocus_subtitle', array('sanitize_callback' => 'zerif_sanitize_text','default' => __('Add a subtitle in Customizer, "About Shakebot section"','zerif-lite')));
	...
	$wp_customize->add_section( 'zerif_aboutus_section' , array(
			...
			'title'       => __( 'How it works section', 'zerif-lite' ),
    ...
    $wp_customize->add_control(
		...
		array(
			...
			'label' => __('How it works section?','zerif-lite'),
	...
	$wp_customize->add_setting( 'zerif_aboutus_subtitle', array('sanitize_callback' => 'zerif_sanitize_text','default' => __('Add a subtitle in Customizer, "How it works section"','zerif-lite')));
	...
	$wp_customize->add_setting( 'zerif_aboutus_text', array('sanitize_callback' => 'zerif_sanitize_text','default' => __('You can add here a large piece of text. For that, please go in the Admin Area, Customizer, "How it works section" <br/> <br/>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc dapibus, eros at accumsan auctor, felis eros condimentum quam, non porttitor est urna vel neque.  <br/> <br/>Maecenas non tellus vitae augue tempor venenatis. Mauris ac tincidunt dolor, id feugiat odio. Mauris egestas ligula sit amet lorem condimentum ultrices','zerif-lite')));
	...
	$wp_customize->add_section( 'zerif_testimonials_section' , array(
			...
			//'title'       => __( 'Testimonials section', 'zerif-lite' ), What makes us unique
			'title'       => __( 'What makes us unique section', 'zerif-lite' ), 
    ...
    $wp_customize->add_control(
		...
		array(
			...
			'label' => __('What makes us unique section?','zerif-lite'),
