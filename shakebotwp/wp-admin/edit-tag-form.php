	...
	<table class="form-table">
		<tr class="form-field form-required term-name-wrap">
			...
			<p class="description"><?php _e('The name is how it appears on your site.'); ?></p></td>
                ...
                <tr class="form-field form-required term-name-wrap">
			<th scope="row"><label for="met"><?php _ex( 'MET (Low Intensity)', 'term name' ); ?></label></th>
			<td><input name="metlow" id="metlow" type="text" value="<?php if ( isset( $tag->metlow ) ) echo esc_attr($tag->metlow); ?>" size="40" aria-required="true" />                       
			<p class="description"><?php _e('The “MET value” is used for the Nutrition Calculation.'); ?></p></td>
		</tr>
                <tr class="form-field form-required term-name-wrap">
			<th scope="row"><label for="met"><?php _ex( 'MET (Medium Intensity)', 'term name' ); ?></label></th>
			<td><input name="metmed" id="metmed" type="text" value="<?php if ( isset( $tag->metmed ) ) echo esc_attr($tag->metmed); ?>" size="40" aria-required="true" />
			<p class="description"><?php _e('The “MET value” is used for the Nutrition Calculation.'); ?></p></td>
		</tr>
                <tr class="form-field form-required term-name-wrap">
			<th scope="row"><label for="met"><?php _ex( 'MET (High Intensity)', 'term name' ); ?></label></th>
			<td><input name="methigh" id="methigh" type="text" value="<?php if ( isset( $tag->methigh ) ) echo esc_attr($tag->methigh); ?>" size="40" aria-required="true" />
			<p class="description"><?php _e('The “MET value” is used for the Nutrition Calculation.'); ?></p></td>
		</tr>
