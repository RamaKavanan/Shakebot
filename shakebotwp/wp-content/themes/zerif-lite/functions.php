...
function zerif_widgets_init()
{
    ...
    register_sidebar(array(
        ...
        'name' => __('About Shakebot', 'zerif-lite'),
    ...
    register_sidebar(array(
        ...
        'name' => __('WHAT MAKES US UNIQUE', 'zerif-lite'),
    ...
    register_sidebar(array(
        ...
        'name' => __('How it works', 'zerif-lite'),
...
class zerif_ourfocus extends WP_Widget
{
    ...
    function zerif_ourfocus()
    {
        ...
        $this->WP_Widget('ctUp-ads-widget', 'Zerif - About Shakebot widget', $widget_ops);
...
class zerif_testimonial_widget extends WP_Widget
{
    ...
    function zerif_testimonial_widget()
    {
        ...
        $this->WP_Widget('zerif_testim-widget', 'Zerif - What makes us unique widget', $widget_ops);
