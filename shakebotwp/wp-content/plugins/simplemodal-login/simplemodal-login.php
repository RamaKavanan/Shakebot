...
<?php
	...
	<form name="loginform" id="loginform" action="%s" method="post">
		<div style="background-color:#eee;margin:-16px; padding:16px 16px 25px 16px; text-align:center">
			<div class="title">%s <span class="modalCloseImg1 simplemodal-close" style="margin:-30px 0px 0px 290px;"></span></div>
			<p style="font-size:13px">Not member yet? &nbsp;&nbsp;<a class="simplemodal-register" style="font-weight:bold" href="%s">%s</a></p>			
		</div><br><br>
		<div class="simplemodal-login-fields">
		<p style="font-size:13px">
			<span><i class="fa fa-user icon-custom-style"></i> </span>%s<br />
			<input type="text" name="log" class="user_login input" value="" size="20" tabindex="10" />
		</p>
		<p style="margin-bottom:-15px;font-size:13px">
			<label style="font-weight:normal; color:#111111"><span><i class="fa fa-lock icon-custom-style"></i> </span>%s<br />
		...
		$output .= sprintf('		
		<p style="font-size:13px; width:200px;margin-top:20px; float:left;"><a class="simplemodal-forgotpw" style="font-weight:bold" href="wp-login.php?action=lostpassword" title="Password Lost and Found">Forgort Password?</a></p>
		<p class="submit" margin-top:-20px;>
		...
		<p class="nav">',									
			...
			$output .= sprintf('							
		<p class="submit">			
			<input type="button" class="simplemodal-close" style="background-color:#CC9900;" value="%s" tabindex="101" />
			<input type="hidden" name="testcookie" value="1" />
		</p>
		<p class="nav">',
				__('CONTINUE AS GUEST', 'simplemodal-login')
			);
		...
		function login_js() {
			...
			wp_localize_script('simplemodal-login', 'SimpleModalLoginL10n', array(
				...
				'incorrect_password' => __('<strong>ERROR</strong>: The password you entered for the username is incorrect.', 'simplemodal-login'),				
...
<form name="registerform" id="registerform" action="%s" method="post">
	<div style="background-color:#eee;margin:-16px; padding:16px 16px 25px 16px; text-align:center">	
			<div class="title">%s <span class="modalCloseImg1 simplemodal-close" style="margin:-30px 0px 0px 290px;"></span></div>				
			<p style="font-size:13px">Already a member? &nbsp;&nbsp;<a class="simplemodal-login" style="font-weight:bold" href="#">Login</a></p>
	...
	<p style="font-size:13px">
		<span><i class="fa fa-envelope icon-custom-style"></i> </span>%s<br />
		<input type="text" name="user_email" class="user_email input" value="" size="25" tabindex="20" />
			...
			$output .= sprintf('
	<p class="reg_passmail" style="font-size:13px; color:#111111; font-weight:normal;">%s</p>
	<p class="submit">
		<input type="button" class="simplemodal-close" value="%s" tabindex="101" style="margin-left:10px;" />
		<input type="submit" name="wp-submit" value="%s" tabindex="100" />		
	</p>
	<p class="nav">',
				__('A password  generation link will be e-mailed to you.', 'simplemodal-login'),
	...
	<form name="lostpasswordform" id="lostpasswordform" action="%s" method="post">
		<div style="background-color:#eee;margin:-16px; padding:35px 16px 25px 16px; text-align:center">
			<div class="title">%s <span class="modalCloseImg1 simplemodal-close" style="margin:-50px 0px 0px 290px;"></span></div>			
		</div><br><br />
		<div class="simplemodal-login-fields">
		<p>
			<span><i class="fa fa-user icon-custom-style"></i> </span>%s<br />
			<input type="text" name="user_login" class="user_login input" value="" size="20" tabindex="10" />
				...
				__('FORGOT PASSWORD', 'simplemodal-login'),
				__('Username or Email', 'simplemodal-login')
			);
