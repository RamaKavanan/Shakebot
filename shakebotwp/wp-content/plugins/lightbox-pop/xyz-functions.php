...
function xyz_lbx_links($links, $file) 
{
	...
	if ($file == $base) 
	{
		...
		$links[] = '<a href="http://kb.xyzscripts.com/wordpress-plugins/lightbox-pop/"  title="FAQ">FAQ</a>';
		$links[] = '<a href="http://docs.xyzscripts.com/wordpress-plugins/lightbox-pop/"  title="Read Me">README</a>';
