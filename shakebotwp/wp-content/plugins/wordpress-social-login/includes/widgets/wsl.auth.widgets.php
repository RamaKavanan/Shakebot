...
<div class="wp-social-login-widget" style="width:120px; float:left; font-size:12px;">

	<div class="wp-social-login-connect-with">Or Login with,<?php //echo $connect_with_label; ?></div>

	<div class="wp-social-login-provider-list" style="padding:0px">
<?php
...
?>
		...
		<a rel="nofollow" style="padding-right:5px" href="<?php echo $authenticate_url; ?>" title="<?php echo sprintf( _wsl__("Connect with %s", 'wordpress-social-login'), $provider_name ) ?>" class="wp-social-login-provider wp-social-login-provider-<?php echo strtolower( $provider_id ); ?>" data-provider="<?php echo $provider_id ?>">
