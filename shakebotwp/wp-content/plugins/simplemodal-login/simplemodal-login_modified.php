...
<?php
	...
	<form name="loginform" id="loginform" action="%s" method="post">
		<div style="background-color:#eee;margin:-16px; padding:16px 16px 25px 16px; text-align:center">
			...
			<p style="font-size:13px">Not member yet? &nbsp;&nbsp;<a class="simplemodal-register" href="%s">%s</a></p>
		</div><br>
		...
		<p class="nav">',
			...
			$output .= sprintf('		
		<a class="simplemodal-forgotpw" href="%s" title="%s" style="font-size:13px">%s</a>
		<p class="submit">
			<input type="submit" name="wp-submit" value="%s" tabindex="100" /><br><br>
			<input type="button" class="simplemodal-close" value="%s" tabindex="101" />
			<input type="hidden" name="testcookie" value="1" />
		</p>
		<p class="nav">',				
				__('wp-login.php?action=lostpassword', 'simplemodal-login'),
				__('Password Lost and Found', 'simplemodal-login'),
				__('Forgort Password', 'simplemodal-login'),				
				__('Log In', 'simplemodal-login'),
...
<form name="registerform" id="registerform" action="%s" method="post">
	...
	<p>
		...
		<input type="text" name="user_email" class="user_email input" value="" size="25" tabindex="20" /></label>
				...
				site_url('index.php/register/', 'login_post'),
				__('Register', 'simplemodal-login'),				
				__('Email', 'simplemodal-login')
			);
