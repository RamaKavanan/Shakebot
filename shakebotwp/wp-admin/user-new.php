...
<?php $usrAd = wp_get_current_user(); //print_r($usrAd);?>
...
<?php } // !is_multisite ?>
	...
	<?php }else{ //Customized?>
	<input type="hidden" name="role" id="role" value="<?php echo $new_user_role = !empty($current_role) ? $current_role : get_option('default_role');?>">
	<?php } //Customized?>
