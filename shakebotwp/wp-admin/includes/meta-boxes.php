...
?><!-- customized -->
<label class="screen-reader-text" for="post_name"><?php _e('Type') ?></label><input name="post_name" type="text" size="13" id="post_name" value="<?php echo esc_attr( apply_filters( 'editable_slug', $post->post_name ) ); ?>" />
<?php
}
